...
sys_env_destroy(envid_t envid)
{
  ...
  800c30:	00 
  800c31:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800c38:	00 
  800c39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c40:	00 
  800c41:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc2:	00 
  800cc3:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d15:	00 
  800d16:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800d1d:	00 
  800d1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d25:	00 
  800d26:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d68:	00 
  800d69:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800d70:	00 
  800d71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d78:	00 
  800d79:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	00 
  800dbc:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800dc3:	00 
  800dc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcb:	00 
  800dcc:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0e:	00 
  800e0f:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800e16:	00 
  800e17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1e:	00 
  800e1f:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e83:	00 
  800e84:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800e8b:	00 
  800e8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e93:	00 
  800e94:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eb5:	75 1d                	jne    800ed4 <set_pgfault_handler+0x2c>
		// First time through!
		// LAB 4: Your code here.
		sys_page_alloc(sys_getenvid(), (void*)(UXSTACKTOP-PGSIZE), PTE_U|PTE_W|PTE_P);
  800eb7:	e8 99 fd ff ff       	call   800c55 <sys_getenvid>
  800ebc:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800ec3:	00 
  800ec4:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800ecb:	ee 
  800ecc:	89 04 24             	mov    %eax,(%esp)
  800ecf:	e8 bf fd ff ff       	call   800c93 <sys_page_alloc>
  ...
  800ed7:	a3 08 20 80 00       	mov    %eax,0x802008
	//cprintf("UPCALL: %p\n",_pgfault_upcall);
	sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall);
  800edc:	e8 74 fd ff ff       	call   800c55 <sys_getenvid>
  800ee1:	c7 44 24 04 f3 0e 80 	movl   $0x800ef3,0x4(%esp)
  800ee8:	00 
  800ee9:	89 04 24             	mov    %eax,(%esp)
  800eec:	e8 ef fe ff ff       	call   800de0 <sys_env_set_pgfault_upcall>
}
  800ef1:	c9                   	leave  
  800ef2:	c3                   	ret    

00800ef3 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800ef4:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800f04:	8b 44 24 08          	mov    0x8(%esp),%eax
	movl 0x10(%esp), %ebx
  800f08:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	subl $4, %ebx
  800f0c:	83 eb 04             	sub    $0x4,%ebx
	movl %eax, (%ebx)
  800f0f:	89 03                	mov    %eax,(%ebx)
	//Note: you should modify the value before it's popped to %esp
	//      Otherwise, for some reason, the eflags will be wrong!!!
	movl %ebx, 0x10(%esp)
  800f11:	89 5c 24 10          	mov    %ebx,0x10(%esp)
	popl %ebx
  800f15:	5b                   	pop    %ebx
	popl %eax
  800f16:	58                   	pop    %eax
