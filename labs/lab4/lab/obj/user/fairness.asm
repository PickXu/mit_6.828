...
umain(int argc, char **argv)
{
  ...
  8000bb:	e8 c0 0d 00 00       	call   800e80 <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 2c 0d 00 00       	call   800f80 <__udivdi3>
  ...
  8002af:	e8 fc 0d 00 00       	call   8010b0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba0:	00 
  800ba1:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800ba8:	00 
  800ba9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bb0:	00 
  800bb1:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
  800bb8:	e8 62 03 00 00       	call   800f1f <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c32:	00 
  800c33:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800c3a:	00 
  800c3b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c42:	00 
  800c43:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
  800c4a:	e8 d0 02 00 00       	call   800f1f <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c85:	00 
  800c86:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800c8d:	00 
  800c8e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c95:	00 
  800c96:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
  800c9d:	e8 7d 02 00 00       	call   800f1f <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cd8:	00 
  800cd9:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800ce0:	00 
  800ce1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce8:	00 
  800ce9:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
  800cf0:	e8 2a 02 00 00       	call   800f1f <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d2b:	00 
  800d2c:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800d33:	00 
  800d34:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3b:	00 
  800d3c:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
  800d43:	e8 d7 01 00 00       	call   800f1f <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d7e:	00 
  800d7f:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800d86:	00 
  800d87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8e:	00 
  800d8f:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
  800d96:	e8 84 01 00 00       	call   800f1f <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800df3:	00 
  800df4:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800dfb:	00 
  800dfc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e03:	00 
  800e04:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
  800e0b:	e8 0f 01 00 00       	call   800f1f <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800e2b:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  800e30:	0f 44 c2             	cmove  %edx,%eax
	int r = sys_ipc_recv(pg);
  800e33:	89 04 24             	mov    %eax,(%esp)
  800e36:	e8 8b ff ff ff       	call   800dc6 <sys_ipc_recv>
	if (r >= 0) {
  800e3b:	85 c0                	test   %eax,%eax
  800e3d:	78 26                	js     800e65 <ipc_recv+0x4d>
	if (from_env_store != NULL) *from_env_store = thisenv->env_ipc_from;
  800e3f:	85 f6                	test   %esi,%esi
  800e41:	74 0a                	je     800e4d <ipc_recv+0x35>
  800e43:	a1 04 20 80 00       	mov    0x802004,%eax
  800e48:	8b 40 74             	mov    0x74(%eax),%eax
  800e4b:	89 06                	mov    %eax,(%esi)
	if (perm_store != NULL) *perm_store = thisenv->env_ipc_perm;
  800e4d:	85 db                	test   %ebx,%ebx
  800e4f:	74 0a                	je     800e5b <ipc_recv+0x43>
  800e51:	a1 04 20 80 00       	mov    0x802004,%eax
  800e56:	8b 40 78             	mov    0x78(%eax),%eax
  800e59:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  800e5b:	a1 04 20 80 00       	mov    0x802004,%eax
  800e60:	8b 40 70             	mov    0x70(%eax),%eax
  800e63:	eb 14                	jmp    800e79 <ipc_recv+0x61>
	} else {
	if (from_env_store != NULL) *from_env_store = 0;
  800e65:	85 f6                	test   %esi,%esi
  800e67:	74 06                	je     800e6f <ipc_recv+0x57>
  800e69:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	if (perm_store != NULL) *perm_store = 0;
  800e6f:	85 db                	test   %ebx,%ebx
  800e71:	74 06                	je     800e79 <ipc_recv+0x61>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800e99:	0f 44 d8             	cmove  %eax,%ebx
  800e9c:	eb 05                	jmp    800ea3 <ipc_send+0x23>
	int r;
	while((r=sys_ipc_try_send(to_env,val,pg,perm)) == -E_IPC_NOT_RECV) {
		sys_yield();
  800e9e:	e8 41 fd ff ff       	call   800be4 <sys_yield>
{
	// LAB 4: Your code here.
	//panic("ipc_send not implemented");
	if (pg == NULL) pg = (void*)0xffffffff;
  ...
  800eaa:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800eae:	89 74 24 04          	mov    %esi,0x4(%esp)
  800eb2:	89 3c 24             	mov    %edi,(%esp)
  800eb5:	e8 e9 fe ff ff       	call   800da3 <sys_ipc_try_send>
  800eba:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800ebd:	74 df                	je     800e9e <ipc_send+0x1e>
		sys_yield();
	}
	if (r<0) panic("IPC Send Failure.");
  800ebf:	85 c0                	test   %eax,%eax
  800ec1:	79 1c                	jns    800edf <ipc_send+0x5f>
  800ec3:	c7 44 24 08 d3 14 80 	movl   $0x8014d3,0x8(%esp)
  800eca:	00 
  800ecb:	c7 44 24 04 3a 00 00 	movl   $0x3a,0x4(%esp)
  800ed2:	00 
  800ed3:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
  800eda:	e8 40 00 00 00       	call   800f1f <_panic>
	return;
}
...
ipc_find_env(enum EnvType type)
{
  ...
  800ef2:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800ef5:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800efb:	8b 52 50             	mov    0x50(%edx),%edx
  800efe:	39 ca                	cmp    %ecx,%edx
  800f00:	75 0d                	jne    800f0f <ipc_find_env+0x28>
			return envs[i].env_id;
  800f02:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f05:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800f0a:	8b 40 40             	mov    0x40(%eax),%eax
  800f0d:	eb 0e                	jmp    800f1d <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800f12:	3d 00 04 00 00       	cmp    $0x400,%eax
  800f17:	75 d9                	jne    800ef2 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  800f19:	66 b8 00 00          	mov    $0x0,%ax
}
  800f1d:	5d                   	pop    %ebp
  800f1e:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f2a:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800f30:	e8 90 fc ff ff       	call   800bc5 <sys_getenvid>
  800f35:	8b 55 0c             	mov    0xc(%ebp),%edx
  800f38:	89 54 24 10          	mov    %edx,0x10(%esp)
  800f3c:	8b 55 08             	mov    0x8(%ebp),%edx
  800f3f:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800f43:	89 74 24 08          	mov    %esi,0x8(%esp)
  800f47:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f4b:	c7 04 24 f0 14 80 00 	movl   $0x8014f0,(%esp)
  800f52:	e8 6a f2 ff ff       	call   8001c1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f57:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f5b:	8b 45 10             	mov    0x10(%ebp),%eax
  800f5e:	89 04 24             	mov    %eax,(%esp)
  800f61:	e8 fa f1 ff ff       	call   800160 <vcprintf>
	cprintf("\n");
  800f66:	c7 04 24 2f 12 80 00 	movl   $0x80122f,(%esp)
  800f6d:	e8 4f f2 ff ff       	call   8001c1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800f72:	cc                   	int3   
  800f73:	eb fd                	jmp    800f72 <_panic+0x53>
