...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801355:	75 1d                	jne    801374 <set_pgfault_handler+0x2c>
		// First time through!
		// LAB 4: Your code here.
		sys_page_alloc(sys_getenvid(), (void*)(UXSTACKTOP-PGSIZE), PTE_U|PTE_W|PTE_P);
  801357:	e8 99 fd ff ff       	call   8010f5 <sys_getenvid>
  80135c:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  801363:	00 
  801364:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  80136b:	ee 
  80136c:	89 04 24             	mov    %eax,(%esp)
  80136f:	e8 bf fd ff ff       	call   801133 <sys_page_alloc>
  ...
  801377:	a3 d0 20 80 00       	mov    %eax,0x8020d0
	//cprintf("UPCALL: %p\n",_pgfault_upcall);
	sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall);
  80137c:	e8 74 fd ff ff       	call   8010f5 <sys_getenvid>
  801381:	c7 44 24 04 93 13 80 	movl   $0x801393,0x4(%esp)
  801388:	00 
  801389:	89 04 24             	mov    %eax,(%esp)
  80138c:	e8 ef fe ff ff       	call   801280 <sys_env_set_pgfault_upcall>
}
  801391:	c9                   	leave  
  801392:	c3                   	ret    

00801393 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  801394:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  8013a3:	53                   	push   %ebx
	movl 0x8(%esp), %eax
  8013a4:	8b 44 24 08          	mov    0x8(%esp),%eax
	movl 0x10(%esp), %ebx
  8013a8:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	subl $4, %ebx
  8013ac:	83 eb 04             	sub    $0x4,%ebx
	movl %eax, (%ebx)
  8013af:	89 03                	mov    %eax,(%ebx)
	//Note: you should modify the value before it's popped to %esp
	//      Otherwise, for some reason, the eflags will be wrong!!!
	movl %ebx, 0x10(%esp)
  8013b1:	89 5c 24 10          	mov    %ebx,0x10(%esp)
	popl %ebx
  8013b5:	5b                   	pop    %ebx
	popl %eax
  8013b6:	58                   	pop    %eax
