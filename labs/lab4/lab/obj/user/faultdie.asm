	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021f:	e8 9c 0c 00 00       	call   800ec0 <__udivdi3>
  ...
  80027f:	e8 6c 0d 00 00       	call   800ff0 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a3:	ff 24 8d 40 12 80 00 	jmp    *0x801240(,%ecx,4)
  ...
  80044f:	c7 44 24 08 9e 11 80 	movl   $0x80119e,0x8(%esp)
  800456:	00 
  ...
  80046f:	c7 44 24 08 a7 11 80 	movl   $0x8011a7,0x8(%esp)
  800476:	00 
  ...
  8004a1:	b8 97 11 80 00       	mov    $0x801197,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b70:	00 
  800b71:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800b78:	00 
  800b79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b80:	00 
  800b81:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800b88:	e8 d0 02 00 00       	call   800e5d <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800c1a:	e8 3e 02 00 00       	call   800e5d <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c55:	00 
  800c56:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800c5d:	00 
  800c5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c65:	00 
  800c66:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800c6d:	e8 eb 01 00 00       	call   800e5d <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ca8:	00 
  800ca9:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800cb0:	00 
  800cb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb8:	00 
  800cb9:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800cc0:	e8 98 01 00 00       	call   800e5d <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cfb:	00 
  800cfc:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800d03:	00 
  800d04:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0b:	00 
  800d0c:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800d13:	e8 45 01 00 00       	call   800e5d <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d4e:	00 
  800d4f:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800d56:	00 
  800d57:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5e:	00 
  800d5f:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800d66:	e8 f2 00 00 00       	call   800e5d <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800dc3:	00 
  800dc4:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800dcb:	00 
  800dcc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd3:	00 
  800dd4:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800ddb:	e8 7d 00 00 00       	call   800e5d <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800df5:	75 1d                	jne    800e14 <set_pgfault_handler+0x2c>
		// First time through!
		// LAB 4: Your code here.
		sys_page_alloc(sys_getenvid(), (void*)(UXSTACKTOP-PGSIZE), PTE_U|PTE_W|PTE_P);
  800df7:	e8 99 fd ff ff       	call   800b95 <sys_getenvid>
  800dfc:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800e03:	00 
  800e04:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800e0b:	ee 
  ...
  800e17:	a3 08 20 80 00       	mov    %eax,0x802008
	//cprintf("UPCALL: %p\n",_pgfault_upcall);
	sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall);
  800e1c:	e8 74 fd ff ff       	call   800b95 <sys_getenvid>
  800e21:	c7 44 24 04 33 0e 80 	movl   $0x800e33,0x4(%esp)
  800e28:	00 
  800e29:	89 04 24             	mov    %eax,(%esp)
  800e2c:	e8 ef fe ff ff       	call   800d20 <sys_env_set_pgfault_upcall>
}
  800e31:	c9                   	leave  
  800e32:	c3                   	ret    
...
_pgfault_upcall:
  ...
  800e43:	53                   	push   %ebx
	movl 0x8(%esp), %eax
  800e44:	8b 44 24 08          	mov    0x8(%esp),%eax
	movl 0x10(%esp), %ebx
  800e48:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	subl $4, %ebx
  800e4c:	83 eb 04             	sub    $0x4,%ebx
	movl %eax, (%ebx)
  800e4f:	89 03                	mov    %eax,(%ebx)
	//Note: you should modify the value before it's popped to %esp
	//      Otherwise, for some reason, the eflags will be wrong!!!
	movl %ebx, 0x10(%esp)
  800e51:	89 5c 24 10          	mov    %ebx,0x10(%esp)
	popl %ebx
  800e55:	5b                   	pop    %ebx
	popl %eax
  800e56:	58                   	pop    %eax
	addl $4, %esp
  800e57:	83 c4 04             	add    $0x4,%esp
	popf
  800e5a:	9d                   	popf   
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e6e:	e8 22 fd ff ff       	call   800b95 <sys_getenvid>
  ...
  800e89:	c7 04 24 f4 13 80 00 	movl   $0x8013f4,(%esp)
  800e90:	e8 fc f2 ff ff       	call   800191 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e95:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e99:	8b 45 10             	mov    0x10(%ebp),%eax
  800e9c:	89 04 24             	mov    %eax,(%esp)
  800e9f:	e8 8c f2 ff ff       	call   800130 <vcprintf>
	cprintf("\n");
  800ea4:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
  800eab:	e8 e1 f2 ff ff       	call   800191 <cprintf>
