...
sys_env_destroy(envid_t envid)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca2:	00 
  800ca3:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800caa:	00 
  800cab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb2:	00 
  800cb3:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d9b:	00 
  800d9c:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800da3:	00 
  800da4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dab:	00 
  800dac:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dee:	00 
  800def:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800df6:	00 
  800df7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfe:	00 
  800dff:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e63:	00 
  800e64:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800e6b:	00 
  800e6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e73:	00 
  800e74:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e95:	75 1d                	jne    800eb4 <set_pgfault_handler+0x2c>
		// First time through!
		// LAB 4: Your code here.
		sys_page_alloc(sys_getenvid(), (void*)(UXSTACKTOP-PGSIZE), PTE_U|PTE_W|PTE_P);
  800e97:	e8 99 fd ff ff       	call   800c35 <sys_getenvid>
  800e9c:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800ea3:	00 
  800ea4:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800eab:	ee 
  800eac:	89 04 24             	mov    %eax,(%esp)
  800eaf:	e8 bf fd ff ff       	call   800c73 <sys_page_alloc>
  ...
  800eb7:	a3 08 20 80 00       	mov    %eax,0x802008
	//cprintf("UPCALL: %p\n",_pgfault_upcall);
	sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall);
  800ebc:	e8 74 fd ff ff       	call   800c35 <sys_getenvid>
  800ec1:	c7 44 24 04 d3 0e 80 	movl   $0x800ed3,0x4(%esp)
  800ec8:	00 
  800ec9:	89 04 24             	mov    %eax,(%esp)
  800ecc:	e8 ef fe ff ff       	call   800dc0 <sys_env_set_pgfault_upcall>
}
  800ed1:	c9                   	leave  
  800ed2:	c3                   	ret    

00800ed3 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800ed4:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800ee3:	53                   	push   %ebx
	movl 0x8(%esp), %eax
  800ee4:	8b 44 24 08          	mov    0x8(%esp),%eax
	movl 0x10(%esp), %ebx
  800ee8:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	subl $4, %ebx
  800eec:	83 eb 04             	sub    $0x4,%ebx
	movl %eax, (%ebx)
  800eef:	89 03                	mov    %eax,(%ebx)
